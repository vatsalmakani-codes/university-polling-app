            ...
            {isAuthenticated ? (
              <div className="profile-container" ref={dropdownRef}>
                <button className="profile-trigger" onClick={toggleDropdown} aria-haspopup="true" aria-expanded={isDropdownOpen}>
                  <img src={`https://api.dicebear.com/7.x/initials/svg?seed=${user?.name}`} alt="User avatar" className="profile-avatar" />
                ...
                {isDropdownOpen && (
                  <div className="profile-dropdown">
                    <div className="dropdown-header">
                      <img src={`https://api.dicebear.com/7.x/initials/svg?seed=${user?.name}`} alt="User avatar" className="profile-avatar-dropdown" />
