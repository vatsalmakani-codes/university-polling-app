...
const ProfilePage = () => {
  ...
  const avatarSrc = imagePreview ? imagePreview : user.profilePicture === '/uploads/default.png'? `https://api.dicebear.com/7.x/initials/svg?seed=${user.name}&backgroundColor=4e73df&fontSize=35&radius=50`
